...
const config: runtime.GetPrismaClientConfig = {
  ...
  "inlineSchema": "generator client {\n  provider     = \"prisma-client\"\n  output       = \"../src/server/generated/prisma\"\n  runtime      = \"nodejs\"\n  // The resource bundle is IIFE, so `import.meta.url` is not available at runtime.\n  // Without this, Prisma emits an ESM-only __dirname shim that throws on load.\n  moduleFormat = \"cjs\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n}\n\nmodel test_account {\n  id        String   @id @default(cuid())\n  license   String\n  createdAt DateTime @default(now())\n}\n",
  "runtimeDataModel": {
    "models": {},
    "enums": {},
    "types": {}
...
config.runtimeDataModel = JSON.parse("{\"models\":{\"test_account\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"license\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"}],\"dbName\":null}},\"enums\":{},\"types\":{}}")
config.parameterizationSchema = {
  strings: JSON.parse("[\"where\",\"test_account.findUnique\",\"test_account.findUniqueOrThrow\",\"orderBy\",\"cursor\",\"test_account.findFirst\",\"test_account.findFirstOrThrow\",\"test_account.findMany\",\"data\",\"test_account.createOne\",\"test_account.createMany\",\"test_account.createManyAndReturn\",\"test_account.updateOne\",\"test_account.updateMany\",\"test_account.updateManyAndReturn\",\"create\",\"update\",\"test_account.upsertOne\",\"test_account.deleteOne\",\"test_account.deleteMany\",\"having\",\"_count\",\"_min\",\"_max\",\"test_account.groupBy\",\"test_account.aggregate\",\"AND\",\"OR\",\"NOT\",\"id\",\"license\",\"createdAt\",\"equals\",\"in\",\"notIn\",\"lt\",\"lte\",\"gt\",\"gte\",\"not\",\"contains\",\"startsWith\",\"endsWith\",\"set\"]"),
...
export interface PrismaClientConstructor {
   ...
   * })
   * // Fetch zero or more Test_accounts
...
/**
  ...
  $extends: runtime.Types.Extensions.ExtendsHook<"extends", Prisma.TypeMapCb<OmitOpts>, ExtArgs, runtime.Types.Utils.Call<Prisma.TypeMapCb<OmitOpts>, {
    extArgs: ExtArgs
      ...
      /**
   * `prisma.test_account`: Exposes CRUD operations for the **test_account** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more Test_accounts
    * const test_accounts = await prisma.test_account.findMany()
    * ```
    */
  get test_account(): Prisma.test_accountDelegate<ExtArgs, { omit: OmitOpts }>;
}
